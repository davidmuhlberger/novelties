...
Product.create!(user: david, name: "Kuodz", url: "http://getkudoz.com", tagline:"Tinder for job searchs", category: "tech")
...
Product.create!(user: david, name: "Le Wagon", url: "http://lewagon.org", tagline:"Best coding bootcamp", category: "education")
